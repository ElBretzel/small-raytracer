...
// Points inherit from Vector3 because they share the same properties (and are computed the same way)
// For ease of use, operations between Points and Vectors are defined
class Point3 : public Vector3
{
public:
    constexpr Point3() : Vector3() {}
    constexpr Point3(double x, double y, double z) : Vector3(x, y, z) {}
...
constexpr Point3 Point3::ORIGIN = Point3(0, 0, 0);